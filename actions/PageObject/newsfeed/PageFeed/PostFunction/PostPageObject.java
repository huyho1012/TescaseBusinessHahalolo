...
public class PostPageObject extends AbstractPage {
    ...
    public boolean checkEditPostNormalDisplay(){
        waitElementToVisible(driver, NewsFeedPageIU.TITLE_EDIT_NORMAL_POST);
        return checkIsDisplayedElement(driver,NewsFeedPageIU.TITLE_EDIT_NORMAL_POST);
    }
}
